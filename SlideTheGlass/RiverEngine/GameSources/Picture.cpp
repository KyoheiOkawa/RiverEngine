...
shared_ptr<Picture> Picture::create()
{
    shared_ptr<Picture> ret(new Picture());
...
bool Picture::init()
{
    ...
    _mesh = MeshResource<PositionNormalTexture>::createWithFile("Assets/pictureFrame");
    
    auto texInfo = Director::getInstance()->getRegesterdTextureInfo("PICTURE_TX");
