...
bool Wall::init()
{
    ...
    _useProgram = Director::getInstance()->getGLProgram("PTStatic");
    ...
    _mesh = MeshResource<PositionNormalTexture>::createWithFile("Assets/Wall");
    
    auto texInfo = Director::getInstance()->getRegesterdTextureInfo("WALL_TX");
